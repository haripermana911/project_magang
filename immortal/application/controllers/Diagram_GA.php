<?php 
	 ...
	 * 
	 */
	class Diagram_GA extends CI_Controller{
		public function __construct(){
			parent::__construct();
			$this->load->model('diagram_pie_GA');
			$this->load->helper('string');
			$this->load->helper(array('url','html','form'));
		}

		public function index(){
			$untukQuery = $this->db->query("SELECT COUNT(*) AS jml, untuk FROM feedback WHERE untuk = 'GA' GROUP BY untuk");
	    ...
	    public function get_data(){
	    	$data = $this->diagram_pie_GA->get_all_data();
